...
const Exam: React.FC = () => {
  ...
  const [showConfirmModal, setShowConfirmModal] = useState(false); // 添加确认模态框状态
    ...
    <div className="max-w-4xl mx-auto">
      {!isExamActive && !examSubmitted ? (
        <div className="text-center py-12">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-700 p-8 max-w-md mx-auto">
            <h3 className="text-xl font-bold mb-4 dark:text-white">
              模拟{currentClass} 类考试
            </h3>

            <div className="mb-6 text-left">
              <h4 className="font-medium mb-2 dark:text-gray-200">考试规则：</h4>
        ...
        <div>
          {examSubmitted && examResults ? (
            ...
            <div className="text-center py-12">
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-700 p-8 max-w-md mx-auto">
                <h3 className="text-2xl font-bold mb-4 dark:text-white">分数</h3>
                ...
                <div className="mb-6 p-4 rounded-lg bg-gray-50 dark:bg-gray-700 text-left">
                  <h4 className="font-medium mb-2 dark:text-gray-200">考试详情：</h4>
                  <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                  ...
                  {examResults.details.map((detail, index) => {
                    ...
                    return (
                      <div
                        ...
                        className={`p-4 rounded-lg border ${detail.isCorrect ? "bg-green-50 dark:bg-green-900/30 border-green-200 dark:border-green-700" : "bg-red-50 dark:bg-red-900/30 border-red-200 dark:border-red-700"}`}
                      >
                        <div
                        ...
                        >
                          <div className="flex flex-col justify-center items-start">
                            <h4 className="font-medium text-start dark:text-gray-200">
                              {isCorrect ? (
                                <span>
                            ...
                            {(isCorrect && isExpanded) || !isCorrect ? (
                              <div className="mt-2 text-sm text-start dark:text-gray-300">
                                {/* 当题目正确且处于展开状态时显示题目内容 */}
                                ...
                                <div>
                                  ...
                                  {detail.correctAnswerTexts.map((text, idx) => (
                                    <span
                                      key={idx}
                                      className="ml-2 px-2 py-1 bg-green-100 dark:bg-green-800 rounded"
                                    >
                                ...
                                <div>
                                  ...
                                  {detail.userAnswer.length > 0 ? (
                                    detail.userAnswerTexts.map((text, idx) => (
                                      <span
                                        key={idx}
                                        className="ml-2 px-2 py-1 bg-blue-100 dark:bg-blue-800 rounded"
                                      >
            ...
            <div>
              {questions.map((question, index) => (
                <div
                  key={question.id}
                  className="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-700 p-6 mb-6"
                >
              ...
              {isExamActive && !examSubmitted && (
                <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 bg-white dark:bg-gray-800 p-3 rounded-lg shadow-lg dark:shadow-gray-700 border dark:border-gray-700 flex items-center gap-3 z-10 min-w-max">
                  <div className="text-xs font-mono whitespace-nowrap dark:text-gray-300">
                    {formatTime(timeLeft)}
                  </div>
                  <div className="text-xs whitespace-nowrap dark:text-gray-300">
